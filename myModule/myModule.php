...
class MyModule extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Display youtube video on front webpage.');
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(   
                        ...
                        'name' => 'MYMODULE_VIDEO_URL', 
                        'required' => true,
						'label' => $this->l('URL of the YouTube video'),
						'desc' => $this->l('Please enter URL video'),
                    ),   
                ),
                'submit' => array(
                    'title' => $this->l('Save'),
    ...
    protected function getConfigFormValues()
    {
        return array(
            ...
            'MYMODULE_VIDEO_URL' => Configuration::get('MYMODULE_VIDEO_URL'),
        );
    }
    ...
    */
    ...
    {
		$youtubeUrl = Configuration::get('MYMODULE_VIDEO_URL');
        $youtubeUrl = strstr($youtubeUrl, '=');
		$youtubeUrl = str_replace('=', '', $youtubeUrl);
        //echo $youtubeUrl;
        $this->context->smarty->assign('youtube_url', $youtubeUrl);
        
        

    return $this->display(__FILE__, 'views/templates/hook/youtube.tpl');
    }
}
